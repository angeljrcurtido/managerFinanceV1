...
export default function ListarEgresos() {
  ...
  return (
    <View className="flex-1 bg-gray-50 dark:bg-gray-900">
      {/* Header */}
      <View className="bg-red-600 dark:bg-red-800 pt-12 pb-6 px-6">
        ...
        <View className="bg-white/10 rounded-2xl p-4 mt-2">
          <Text className="text-red-100 text-sm mb-1">Total de Egresos</Text>
      ...
      <View className="absolute bottom-6 right-6 left-6">
        <TouchableOpacity
          onPress={() => router.back()}
          activeOpacity={0.9}
          className="bg-red-600 dark:bg-red-700 py-4 rounded-2xl shadow-lg flex-row items-center justify-center"
        >
          <MaterialIcons name="add-circle" size={24} color="white" />
          <Text className="text-white font-bold text-lg ml-2">Nuevo Egreso</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
